...
@Operation(
        summary = "Responsável pela alteração de status de um dispositivo." )
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Status do dispositivo alterado no sistema.",
                content=@Content),
        @ApiResponse(
                responseCode = "403",
...
public @interface UpdateDispositivoStatusDoc {
