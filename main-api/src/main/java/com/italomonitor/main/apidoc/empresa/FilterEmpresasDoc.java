package com.italomonitor.main.apidoc.empresa;
...
@Operation(
        summary = "Responsável filtrar e retornar dados completos das empresas."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Retorno de lista de dados completos das empresas conforme os campos do filtro.",
                content = {@Content(
...
public @interface FilterEmpresasDoc {
