package com.italomonitor.main.apidoc.usuario;
...
@Operation(
        summary = "Responsável por retornar os grupos do usuário pelo ID do usuário."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Grupos de usuário retornados pelo ID do usuário.",
                content = @Content(
...
public @interface GetUsuarioGruposByUsuarioIDDoc {
