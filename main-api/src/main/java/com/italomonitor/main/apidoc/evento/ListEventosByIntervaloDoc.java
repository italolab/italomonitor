package com.italomonitor.main.apidoc.evento;
...
@Operation(
        summary = "Responsável retornar a lista de eventos do dispositivo pelo intervalo de dias."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Retorno de lista de eventos do dispositivo pelo intervalo de dias.",
                content = {@Content(
...
public @interface ListEventosByIntervaloDoc {
}
