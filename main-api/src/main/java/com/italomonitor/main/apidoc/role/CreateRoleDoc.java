package com.italomonitor.main.apidoc.role;
...
@Operation(
        summary = "Responsável pelo registro de um role." )
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Role registrado no sistema.",
                content=@Content),
        @ApiResponse(
                responseCode = "403",
...
public @interface CreateRoleDoc {
