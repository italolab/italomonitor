package com.italomonitor.main.apidoc.agente;
...
@Operation(
        summary = "Responsável filtrar e retornar dados completos dos agentes da empresa."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Retorno de lista de dados completos dos agentes da empresa conforme os campos do filtro.",
                content = {@Content(
...
public @interface FilterAgentesDoc {
