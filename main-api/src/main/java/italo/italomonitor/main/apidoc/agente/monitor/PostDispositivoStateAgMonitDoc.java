...
@Operation(
        summary = "Responsável por receber o estado do dispositivo e processar."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Estado do dispositivo recebido com sucesso.",
                content = @Content),
        @ApiResponse(
                responseCode = "403",
...
public @interface PostDispositivoStateAgMonitDoc {
