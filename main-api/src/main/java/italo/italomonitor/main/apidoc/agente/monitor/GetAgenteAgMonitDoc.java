...
@Operation(
        summary = "Responsável por retornar dados do agente e IDs de seus dispositivos pela chave."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Dados do agente e IDs de seus dispositivos retornados.",
                content = {@Content(
                        mediaType = MediaType.APPLICATION_JSON_VALUE,
                        schema = @Schema(implementation =  DispMonitorAgente.class))}),
        @ApiResponse(
                responseCode = "403",
...
public @interface GetAgenteAgMonitDoc {
