...
@Operation(
        summary = "Responsável por retornar dados de configuração para um agente."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Dados de configuração retornados.",
                content = {@Content(
                        mediaType = MediaType.APPLICATION_JSON_VALUE,
                        schema = @Schema(implementation =  DispMonitorConfig.class))}),
        @ApiResponse(
                responseCode = "403",
...
public @interface GetConfigAgMonitDoc {
