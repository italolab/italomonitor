...
@Operation(
        summary = "Responsável por retornar dados de um dispositivo por ID para um agente."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Dados de dispositivo retornados pelo ID.",
                content = {@Content(
                        mediaType = MediaType.APPLICATION_JSON_VALUE,
                        schema = @Schema(implementation =  DispMonitorDispositivo.class))}),
        @ApiResponse(
                responseCode = "403",
...
public @interface GetDispositivoAgMonitDoc {
