...
import type { NoAdminSaveEmpresaRequest } from "../../core/model/dto/request/NoAdminSaveEmpresaRequest";

function NoAdminUpdateEmpresa() {
    ...
    const onSave = async () => {
        ...
        try {
            ...
            const eid : number = parseInt( empresaId! );
            await noAdminUpdateEmpresa( eid, empresa );                        
        } catch ( error ) {
            console.error( error );
        }
    };
    ...
    return (
        <AppLayout>
            ...
            <h3 className="title">Alteração de empresa</h3>
...
export default NoAdminUpdateEmpresa;