...
public class DispositivoMonitorController {
    ...
    public ResponseEntity<String> startMonitoramento( @PathVariable Long dispositivoId ) {
        dispositivoMonitorService.startMonitoramento( dispositivoId );
    ...
    public ResponseEntity<String> stopMonitoramento( @PathVariable Long dispositivoId ) {
        dispositivoMonitorService.stopMonitoramento( dispositivoId );
