...
@Operation(
        summary = "Responsável por atualizar os dados de configuração nos monitoramentos em execução."
)
@ApiResponses(value= {
        @ApiResponse(
                responseCode = "200",
                description = "Dados de configurações atualizados nos monitoramentos em execução.",
                content = @Content),
        @ApiResponse(
                responseCode = "403",
...
public @interface UpdateConfigInMonitoresDoc {
